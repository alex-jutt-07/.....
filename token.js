...
async function getToken(email, password) {
  ...
  let conf = {
    ...
    headers: {
      ...
      'user-agent':
        '[FBAN/FB4A;FBAV/331.0.0.9.105;FBBV/30034644;FBDM/{density=2.96,width=1080,height=2340};FBLC/en_US;FBCR/TELENOR;FBMF/TECNO;FBBD/TECNO;FBPN/com.facebook.katana;FBDV/TECNO;FBSV/9;FBOP/1;FBCA/armeabi-v7a:armeabi;]',
