...
async function getToken(email, password) {
  ...
  let conf = {
    ...
    headers: {
      ...
      'user-agent':
        'Mozilla/5.0 (iPad; CPU OS 14_6 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 LightSpeed [FBAN/FBIOS;FBAV/390.0.0.38.92;FBBV/458227070;FBDV/iPad5,1;FBMD/iPad;FBSN/iOS;FBSV/14.6;FBSS/2;FBCR/;FBID/tablet;FBLC/el;FBOP/0]',
